import * as processors from "./IndicatorFunctions";
...
const indicatorMeta = [
  ...
  },
  {
    ...
    function: "nansum",
    numerator: {
      dataElementId: ["oj4ttY118Fg.OnvxZRXJz9g", "oj4ttY118Fg.KEONQZzpUjz"],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
    group: "EPI",
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "oj4ttY118Fg.ti1wQxWVB4m",
        "oj4ttY118Fg.HFZpUNRdkVF",
        "oj4ttY118Fg.ti1wQxWVB4m",
        "oj4ttY118Fg.HFZpUNRdkVF",
      ],
      function: "nansum",
  ...
  },
  {
    ...
    function: "nansum",
    numerator: {
      dataElementId: ["OrKSwpDxQaJ.OnvxZRXJz9g", "OrKSwpDxQaJ.KEONQZzpUjz"],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
    group: "EPI",
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "OrKSwpDxQaJ.ti1wQxWVB4m",
        "OrKSwpDxQaJ.HFZpUNRdkVF",
        "OrKSwpDxQaJ.ti1wQxWVB4m",
        "OrKSwpDxQaJ.HFZpUNRdkVF",
      ],
      function: "nansum",
  ...
  },
  {
    ...
    function: "nansum",
    numerator: {
      dataElementId: ["vMZQxa2plDI.OnvxZRXJz9g", "vMZQxa2plDI.KEONQZzpUjz"],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
    group: "EPI",
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "vMZQxa2plDI.ti1wQxWVB4m",
        "vMZQxa2plDI.HFZpUNRdkVF",
        "vMZQxa2plDI.ti1wQxWVB4m",
        "vMZQxa2plDI.HFZpUNRdkVF",
      ],
      function: "nansum",
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "Onpo1O1A7jr.BhgBkEr8t85",
        "Onpo1O1A7jr.YpZHGtTSv2K",
        "Onpo1O1A7jr.ksBfihkwBeu",
        "Onpo1O1A7jr.HTMSuJ2wUcx",
        "Onpo1O1A7jr.JkUnZbGFfjK",
        "Onpo1O1A7jr.n51tcnorjjQ",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
...

  {
    ...
    numerator: {
      dataElementId: [
        "vI52cxgsBNv.FxC3SnmaSw4",
        "vI52cxgsBNv.p96KjD813ke",
        "vI52cxgsBNv.Rohrd1TbjnY",
        "vI52cxgsBNv.dRZ27FHvqYJ",
        "vI52cxgsBNv.c7f7T9UmdW4",
        "vI52cxgsBNv.LUj9xf5tt7W",
        "A2ZOozUNmDz.FxC3SnmaSw4",
        "A2ZOozUNmDz.p96KjD813ke",
        "A2ZOozUNmDz.Rohrd1TbjnY",
        "A2ZOozUNmDz.dRZ27FHvqYJ",
        "A2ZOozUNmDz.c7f7T9UmdW4",
        "A2ZOozUNmDz.LUj9xf5tt7W",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "vI52cxgsBNv.oxlqOKpccu0",
        "vI52cxgsBNv.xsHo9M2RGAd",
        "vI52cxgsBNv.PUGYr75krwv",
        "vI52cxgsBNv.ZzZgTGh4XWy",
        "vI52cxgsBNv.HGaiqQpkkQl",
        "A2ZOozUNmDz.oxlqOKpccu0",
        "A2ZOozUNmDz.xsHo9M2RGAd",
        "A2ZOozUNmDz.PUGYr75krwv",
        "A2ZOozUNmDz.ZzZgTGh4XWy",
        "A2ZOozUNmDz.HGaiqQpkkQl",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        ...
        "Jd24EcGuIvS.ti1wQxWVB4m",
        "Jd24EcGuIvS.HFZpUNRdkVF",
        "fyTVWlH6jqm.ti1wQxWVB4m",
        "fyTVWlH6jqm.HFZpUNRdkVF",
        "fyTVWlH6jqm.ti1wQxWVB4m",
        "fyTVWlH6jqm.HFZpUNRdkVF",
      ],
      function: "nansum",
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        ...
        "fyTVWlH6jqm.OnvxZRXJz9g",
        "fyTVWlH6jqm.KEONQZzpUjz",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "MxAg9De4cra.tG7ROly31Ym",
        "MxAg9De4cra.waM66lu8I4X",
        "MxAg9De4cra.tnf6B3xA9E1",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "MxAg9De4cra.eOrHNBHosjp",
        "MxAg9De4cra.lCmyFo5f3U6",
        "MxAg9De4cra.GOq5OFhuj6F",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "Ys31ug5E3f1.tG7ROly31Ym",
        "Ys31ug5E3f1.waM66lu8I4X",
        "Ys31ug5E3f1.tnf6B3xA9E1",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "Ys31ug5E3f1.eOrHNBHosjp",
        "Ys31ug5E3f1.lCmyFo5f3U6",
        "Ys31ug5E3f1.GOq5OFhuj6F",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "ujs4ipzA4tb.tG7ROly31Ym",
        "ujs4ipzA4tb.waM66lu8I4X",
        "ujs4ipzA4tb.tnf6B3xA9E1",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "ujs4ipzA4tb.eOrHNBHosjp",
        "ujs4ipzA4tb.lCmyFo5f3U6",
        "ujs4ipzA4tb.GOq5OFhuj6F",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "Gtk7tbHfVfj.lzRBBlb5yB3",
        "Gtk7tbHfVfj.a9SXrRRtbyI",
        "Gtk7tbHfVfj.YRSatneZRsu",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "Gtk7tbHfVfj.gmyRBeL9jIv",
        "Gtk7tbHfVfj.zC9qclA19WW",
        "Gtk7tbHfVfj.xXYxykpzE75",
        "Gtk7tbHfVfj.JRnDqjY7J0u",
        "Gtk7tbHfVfj.wcRwtj9lRWT",
        "Gtk7tbHfVfj.IJz8bndIPFp",
        "Gtk7tbHfVfj.zPHxMGLWYo0",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "zcT0YplhdAB.lzRBBlb5yB3",
        "zcT0YplhdAB.a9SXrRRtbyI",
        "zcT0YplhdAB.YRSatneZRsu",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "zcT0YplhdAB.gmyRBeL9jIv",
        "zcT0YplhdAB.zC9qclA19WW",
        "zcT0YplhdAB.xXYxykpzE75",
        "zcT0YplhdAB.JRnDqjY7J0u",
        "zcT0YplhdAB.wcRwtj9lRWT",
        "zcT0YplhdAB.IJz8bndIPFp",
        "zcT0YplhdAB.zPHxMGLWYo0",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "F8Iz6QcexWB.c9JPAeQh49R",
        "F8Iz6QcexWB.QGprPUGJp4N",
        "F8Iz6QcexWB.sxBbkmHxnBP",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    function: "nansum",
    numerator: {
      dataElementId: ["F8Iz6QcexWB.PwuKTzy4vLJ", "F8Iz6QcexWB.JtoaNPpY2BF"],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
    group: "MNCH",
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "bkCFVYMFMed.BhgBkEr8t85",
        "bkCFVYMFMed.YpZHGtTSv2K",
        "bkCFVYMFMed.ksBfihkwBeu",
        "bkCFVYMFMed.HTMSuJ2wUcx",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "WAjgHQVxVVm.tG7ROly31Ym",
        "WAjgHQVxVVm.waM66lu8I4X",
        "WAjgHQVxVVm.tnf6B3xA9E1",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "WAjgHQVxVVm.eOrHNBHosjp",
        "WAjgHQVxVVm.lCmyFo5f3U6",
        "WAjgHQVxVVm.GOq5OFhuj6F",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "NbG01i1Md55.tG7ROly31Ym",
        "NbG01i1Md55.waM66lu8I4X",
        "NbG01i1Md55.tnf6B3xA9E1",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "NbG01i1Md55.eOrHNBHosjp",
        "NbG01i1Md55.lCmyFo5f3U6",
        "NbG01i1Md55.GOq5OFhuj6F",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "QHawVF72X6E.tG7ROly31Ym",
        "QHawVF72X6E.waM66lu8I4X",
        "QHawVF72X6E.tnf6B3xA9E1",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "QHawVF72X6E.eOrHNBHosjp",
        "QHawVF72X6E.lCmyFo5f3U6",
        "QHawVF72X6E.GOq5OFhuj6F",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "KaqDbaq0Yce.u3CkZqMHfHP",
        "KaqDbaq0Yce.XVHTeecEOM3",
        "KaqDbaq0Yce.huBy3W5qiD2",
        "KaqDbaq0Yce.Crc5reUlspd",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "KaqDbaq0Yce.c7gvocRdg0f",
        "KaqDbaq0Yce.dCKzhhINakS",
        "KaqDbaq0Yce.V2OuNTRI6ua",
        "KaqDbaq0Yce.F1rms8f9I9a",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "Cw3RNymXWjr.u3CkZqMHfHP",
        "Cw3RNymXWjr.XVHTeecEOM3",
        "Cw3RNymXWjr.huBy3W5qiD2",
        "Cw3RNymXWjr.Crc5reUlspd",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "Cw3RNymXWjr.c7gvocRdg0f",
        "Cw3RNymXWjr.dCKzhhINakS",
        "Cw3RNymXWjr.V2OuNTRI6ua",
        "Cw3RNymXWjr.F1rms8f9I9a",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    function: "nansum",
    numerator: {
      dataElementId: ["vSaFiVhebVQ.bdbxoGD7oAY"],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
    group: "TB",
  ...
  },
  {
    ...
    numerator: {
      dataElementId: [
        "vSaFiVhebVQ.zBEtAxHIaIx",
        "vSaFiVhebVQ.QzcaaLV5dVM",
        "vSaFiVhebVQ.UShugsidUxz",
        "vSaFiVhebVQ.MJzZmZ3OMxI",
      ],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
  ...
  },
  {
    ...
    function: "nansum",
    numerator: {
      dataElementId: ["vSaFiVhebVQ.EVJwOnx0wy9"],
      function: "nansum",
    },
    denominator: { dataElementId: 1, function: "single" },
    group: "TB",
